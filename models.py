...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f"Designation: {self.designation}, name: {self.name}, diameter: {self.diameter}, " \
...
class CloseApproach:
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f'Designation: {self._designation}, time: {self.time}, distance: {self.distance}, ' \
